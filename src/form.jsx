		...
		<div className=" my-10 container max-w-md mx-auto">
			<form action="" className="flex flex-col mx-auto justify-center">
				...
				<input
					...
					className=" mb-6 max-w-md bg-red-300 border-black p-2 rounded-md appearance-none border-2"
				/>
				<button className="relative px-8 py-3 font-bold text-black group self-center">
